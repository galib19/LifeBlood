    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bloodRequestBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent bloodRequestIntent = new Intent(MainActivity.this, BloodRequestActivity.class);
        ...
        showMap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent showMapIntent = new Intent(MainActivity.this, Test.class);
                ...
                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                    if (task.isSuccessful()) {
                        ...
                        if (!task.getResult().exists()) {
                            ...
                            Glide.with(MainActivity.this).setDefaultRequestOptions(placeholderRequest).load(image).into(mainProfileImage);
                        }
                    } else {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.deactivating_donor_btn:
                Intent donor_deactivation = new Intent(MainActivity.this, DonorDeactivationActivity.class);
